            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">Add User Data</h2>
                                        ...
                                        <form action="" method="post" autocomplete="off">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-8">
                                                    <input type="text" name="fullname" id="fullname" placeholder="Fullname" class="form-control" value="<?= set_value('fullname'); ?>">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right" for="password">password<span class="text-danger">*</span></label>
                                                <div class="col-12 col-sm-8 col-lg-8">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right" for="password2">Confirm Password<span class="text-danger">*</span></label>
                                                <div class="col-12 col-sm-8 col-lg-8">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-8">
                                                    <textarea name="address" id="address" cols="30" rows="10" class="form-control"><?= set_value('fullname'); ?></textarea>
